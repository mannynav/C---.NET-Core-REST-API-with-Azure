...
namespace DotnetAPI.Controllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        /// <summary>
        /// /// Get endpoint for postId,userId, searchParam
        /// </summary>
        ...
        public IEnumerable<Post> GetPosts(int postId, int userId, string searchParam = "None")
        {
            ...
            if (searchParam.ToLower() != "none")
            {
                ...
                sqlParameters.Add("@SearchValueParameter", searchParam, DbType.Int32);
            }
        ...
        /// <summary>
        /// Get endpoint to get all posts by the authenticated user
        /// </summary>
        [HttpGet("MyPosts")]
        ...
        /// <summary>
        /// Post endpoint to add a post - we can use a Dto since we dont need everything that is in the model
        /// </summary>
        [HttpPut("UpsertPost")]
        ...
        /// <summary>
        /// Delete endpoint to delete a post - must be authenticated
        /// </summary>
